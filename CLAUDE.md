...
Le Cell comunicano solo tramite contratti OpenAPI in contracts/.
...
|-----------------|----------------|-------|----------------------------|
| Catalogo        | cell-catalog/  | 3001  | contracts/catalog-api.yaml |
| Gestione Ordini | cell-orders/   | 3002  | contracts/orders-api.yaml  |
