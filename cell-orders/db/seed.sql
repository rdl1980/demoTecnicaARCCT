...
INSERT INTO order_lines (order_id, sku, product_name, quantity, unit_price_cents) VALUES
  (1, 'CAT-00001', 'Filtro olio motore SAME Explorer 3', 2, 2490),
  (1, 'CAT-00008', 'Filtro idraulico Fendt Vario',       3, 7470);
...
INSERT INTO order_lines (order_id, sku, product_name, quantity, unit_price_cents) VALUES
  (2, 'CAT-00002', 'Cinghia distribuzione Deutz-Fahr', 1, 8900);
...
INSERT INTO order_lines (order_id, sku, product_name, quantity, unit_price_cents) VALUES
  (3, 'CAT-00004', 'Iniettore carburante John Deere 6R', 1, 18900),
  (3, 'CAT-00006', 'Pompa idraulica SAME Dorado',        1, 34500);
